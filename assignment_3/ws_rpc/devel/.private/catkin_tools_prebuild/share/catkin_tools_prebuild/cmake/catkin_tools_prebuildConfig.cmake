...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /homeL/1wang/RPC2023/assignment_3/ws_rpc/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /homeL/1wang/RPC2023/assignment_3/ws_rpc/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /homeL/1wang/RPC2023/assignment_3/ws_rpc/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/homeL/1wang/RPC2023/assignment_3/ws_rpc/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /homeL/1wang/RPC2023/assignment_3/ws_rpc/devel/.private/catkin_tools_prebuild/lib;/homeL/1wang/RPC2023/assignment_3/ws_rpc/devel/lib;/opt/ros/noetic/lib)
